...
function EditProduct() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (data) => {
      try {
        await axios.put(`https://628b701f7886bbbb37b83ca6.mockapi.io/product/${params.id}`, data)
        alert("Edit data is Done")
      } catch (error) {
  ...
  let ComeData = async () => {
    try {
      let set = await axios.get(`https://628b701f7886bbbb37b83ca6.mockapi.io/product/${params.id}`)
      formik.setValues({
