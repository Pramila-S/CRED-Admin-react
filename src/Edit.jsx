...
function Edit() {
  ...
  const formic = useFormik({
    ...
    onSubmit :async(value)=>{
     await axios.put(`https://628b701f7886bbbb37b83ca6.mockapi.io/users/${params.id}`,value)
  ...
  let loadUser =  async()=>{
    try {
      let user =  await axios.get(`https://628b701f7886bbbb37b83ca6.mockapi.io/users/${params.id}`)
      formic.setValues({
        name : user.data.name,
